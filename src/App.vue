<template>
  <div id="app">
                  ...
                  <div class="timeline-panel wow fadeInUp">
                    <div class="timeline-content">
                      <div class="timeline-heading">
                        ...
                        <span
                          >BA(Hons) in UI Engineering, Arts University, Pabna,
                          USA</span
                        >
                      </div>
                      <!-- /timeline-heading -->
                      ...
                      <div class="timeline-body">
                        <p>
                          I have completed UI Engineering degree from ABC
                          University, Boston, USA at feel the charm of existence
                          in this spot, which was creat.
                        </p>
                      </div>
                      <!-- /timeline-body -->
                    </div>
                ...
                <li class="timeline-inverted">
                  ...
                  <div class="timeline-panel wow fadeInUp">
                    <div class="timeline-content">
                      ...
                      <div class="timeline-body">
                        <p>
                          From this college of existence in this spot, which was
                ...
                <li>
                  ...
                  <div class="timeline-panel wow fadeInUp">
                    <div class="timeline-content">
                      ...
                      <div class="timeline-body">
                        <p>
                          I was awesome at arts, and feel the charm of existence
                ...
                <li>
                  ...
                  <div class="timeline-panel wow fadeInUp">
                    <div class="timeline-content">
                      ...
                      <div class="timeline-body">
                        <p>
                          Completely provide access to seamless manufactured
                          products before functionalized synergy. Progressively
    ...
    <section id="works" class="works-section section-padding">
      <div class="container">
        ...
        <div class="row">
          <div id="grid">
            <div
              class="portfolio-item col-xs-12 col-sm-4 col-md-3"
              ...
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <div class="links">
                    <a
                      class="image-link"
                      href="assets/images/works/portfolio-1.jpg"
              ...
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <div class="links">
                    <a
                      class="image-link"
                      href="assets/images/works/portfolio-2.jpg"
                      ><i class="fa fa-search-plus"></i
                    ></a>
                    <a href="#"><i class="fa fa-link"></i></a>
                  </div>
              ...
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <div class="links">
                    <a
                      class="image-link"
                      href="assets/images/works/portfolio-3.jpg"
                      ><i class="fa fa-search-plus"></i
                    ></a>
                    <a href="#"><i class="fa fa-link"></i></a>
                  </div>
              ...
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <div class="links">
                    <a
                      class="image-link"
                      href="assets/images/works/portfolio-4.jpg"
                      ><i class="fa fa-search-plus"></i
                    ></a>
                    <a href="#"><i class="fa fa-link"></i></a>
                  </div>
              ...
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <div class="links">
                    <a
                      class="image-link"
                      href="assets/images/works/portfolio-5.jpg"
                      ><i class="fa fa-search-plus"></i
                    ></a>
                    <a href="#"><i class="fa fa-link"></i></a>
                  </div>
              ...
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <div class="links">
                    <a
                      class="image-link"
                      href="assets/images/works/portfolio-6.jpg"
                      ><i class="fa fa-search-plus"></i
                    ></a>
                    <a href="#"><i class="fa fa-link"></i></a>
                  </div>
              ...
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <div class="links">
                    <a
                      class="image-link"
                      href="assets/images/works/portfolio-7.jpg"
                      ><i class="fa fa-search-plus"></i
                    ></a>
                    <a href="#"><i class="fa fa-link"></i></a>
                  </div>
              ...
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <div class="links">
                    <a
                      class="image-link"
                      href="assets/images/works/portfolio-8.jpg"
                      ><i class="fa fa-search-plus"></i
                    ></a>
                    <a href="#"><i class="fa fa-link"></i></a>
                  </div>
    ...
    <section
      id="facts"
      class="facts-section text-center"
      data-stellar-vertical-offset="50"
      data-stellar-background-ratio="0.2"
    >
